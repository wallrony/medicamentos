...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void initState() {
    ...
    appBar = AppBar(
      ...
      leading: FadeAnimation(0.6, GestureDetector(
  ...
  Widget makeHeader() {
    return Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          FadeAnimation(1, CustomText(
            text: "Cadastre-se",
            fontSize: 42,
            isBold: true,
          )),
          FadeAnimation(1.2, CustomText(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                FadeAnimation(1.6, makeInput(
                  label: "Nome de Usuário",
                  controller: userController,
                  validateFun: validateUser,
                )),
                FadeAnimation(1.8, makeInput(
                  label: "Senha",
                  obscureText: true,
                  controller: pswdController,
                  validateFun: validatePswd,
                )),
                FadeAnimation(2, makeInput(
  ...
  register() async {
    if(formKey.currentState.validate()) {
      ...
      final response = await Facade().register(name, user, pswd);
